      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-2/3">
                ...
                >
                  Bespoke software solutions that bridge the gap between innovation and practicality
                </motion.p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div>
                <motion.h2 
                  ...
                  className="text-3xl font-bold text-gray-900 mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800"
                >
                  Our Services
                </motion.h2>
                  ...
                  {[
                    {
                      ...
                      description: "Development of tailored AI models for your specific needs",
                      icon: "🤖"
                    },
                    {
                    ...
                    },
                    {
                      ...
                      description: "Modern, responsive web applications with cutting-edge features",
                      icon: "🌐"
                    },
                    {
                    ...
                    <motion.div
                      ...
                      className="bg-white p-6 rounded-xl shadow-lg transition-all duration-300 hover:bg-blue-50 group"
                    >
                  ...
                  {[
                    {
                      ...
                      description: "Custom-built software that perfectly fits your requirements",
                      icon: "🎯"
                    },
                    {
                      title: "Expert Team",
                      description: "Skilled developers with extensive experience",
                      icon: "👨‍💻"
                    },
                    {
                    ...
                    },
                    {
                      ...
                      description: "Scalable and maintainable solutions for long-term success",
                      icon: "🚀"
                    }
                  ].map((benefit, index) => (
                    <motion.div
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">{benefit.title}</h3>
        ...
        <section className="py-20 bg-gray-900 text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              Let's discuss how our custom development services can help you achieve your goals
            </motion.p>
            <motion.a
              href="/contact"
              whileHover={{ 
